    ...
    public static boolean validate(String name, String pass) {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/users?useUnicode=yes&characterEncoding=UTF-8&useSSL=false&allowPublicKeyRetrieval=true", "malik", "Passsword"); // creating a connection with mysql database
